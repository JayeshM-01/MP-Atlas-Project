...
export const Cards = () => {
  return (
    <div className="App">
        <div id="Cards" className='flex items-center justify-center'>
        <div class="container">
      <div className="row">
        <div className="col-xs-12">
          <div className="text-center">
            <div className="p-head">
              <strong >DISTRICTs OF Madhya Pradesh</strong>
            </div>
          </div>
          <div className="tabs-container">
            <ul className="tabs-menu flex items-center justify-center">
              <li className="active">
                <a href="#">Districts</a>
              </li>

            </ul>
            <div className="tab mx-8">
{/* //////////////////////////////////// */}
